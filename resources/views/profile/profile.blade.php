        ...
        <div class="card-body">
          ...
          <form action="{{route('user.update')}}" method="POST">
            ...
            <div class="row">
              ...
              <div class="form-group pt-2 col-md-6">
                <label for="same_password">Shkruaj passwordin e njejt</label>
                <input class="form-control" name="password_confirmation" id="same_password" type="password" placeholder="">
              </div>
