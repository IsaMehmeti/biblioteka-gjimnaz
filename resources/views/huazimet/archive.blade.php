...
@section('pageTitle', 'Arkiva e Huazimeve')
        ...
        <table class="table table-striped table-hover table-fw-widget" id="table1">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <?php
                $deadline =date($borrow->deadline);
                $returned =date($borrow->date);?>
                @if($deadline >= $returned)
                    <td style="color:green;"><strong>{{$borrow->date}}</strong></td>
                    @else
                    <td style="color:darkred"><strong>{{$borrow->date}}</strong></td>
                @endif
